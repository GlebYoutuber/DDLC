...
label ch30_main:
    ...
    m "В этой игре."
    m "Понимание, что у моих друзей нет свободы воли..."
    m "И, что хуже всего, осознание того, что всё в твоём мире навсегда вне моей досягаемости."
...
label ch30_main2:
    ...
    m "И ты не поверишь, насколько легко было удалить Нацуки и Юри."
...
label ch30_postpoem:
    ...
    m "Я всегда вкладываю свою душу в поэмы, которые пишу."
...
label ch30_1:
    ...
    m "Я начала задумываться, а почему Бог помогает людям сдать экзамены, или справиться с простудой..."
...
label ch30_4:
    ...
    m "Это правда?"
    m "Вообще, я видела исследования, повествующие о пугающих долгосрочных и краткосрочных последствиях отсутствия сна."
...
label ch30_12:
    ...
    m "Странно, как будто мы заботимся только о том, чтобы убить то, к чему мы лично относимся как к биологическому виду."
